...
// File: contracts/WrappedLINK.sol
...
contract BridgeToken is ERC20Burnable, ERC677 {
    using Roles for Roles.Role;

    Roles.Role private bridgeRoles;

    string private constant TOKEN_NAME = "Chainlink Token";
    string private constant TOKEN_SYMBOL = "LINK.e";
     ...
     * @param chainId Chain ID to unwrap or migrate funds to. Only used for multi-network bridge deployment.
     ...
     * @return Current swap token supply.
     */
