...
//    mapping(uint256 => uint256) private _balancesByEdition;
//
//    /* ========== MODIFIERS ========== */
//
...
//        require(
//            playerCollection.ownerOf(tokenId) == account,
...
//
//    function initialize(address _token, address _playerCollection, address _powerReconstructor, address _nftController)
//    external
//    initializer
//    {
//        // TODO: uncomment
...
//    }
//
////    function reconstructEdition(
////        uint256 editionId,
////        uint16 addedPower
////    ) external override updateReward(0, false) {
////
////        require(powerReconstructor == _msgSender(), "invalid caller");
////
////        uint256 balance = _balancesByEdition[editionId];
////        _totalSupply = _totalSupply.add(balance.mul(addedPower));
////    }
////
...
//            amount.mul(nftController.getNftCustomPower(tokenId))
//        );
//
//        _balances[tokenId] = _balances[tokenId].add(amount);
//
//        uint256 editionId = nftController.getEditionId(tokenId);
//        _balancesByEdition[editionId] = _balancesByEdition[editionId].add(amount);
//
...
//    // }
//
//    function updateRewardBeforeTokenTransfer(uint256 tokenId) public updateReward(tokenId, true) {}
//
...
//    }
//
//    function setNFTControllerAddress(address _nftControllerAddress)
//    external
//    onlyOwner
//    returns (bool)
//    {
//        nftController = INFTController(_nftControllerAddress);
//
//        return true;
//    }
//
...
//        return
//        _balances[tokenId]
//        .mul(nftController.getNftCustomPower(tokenId))
...
//
//        uint256 editionId = nftController.getEditionId(tokenId);
//        _balancesByEdition[editionId] = _balancesByEdition[editionId].sub(amount);
//
